...
#  $cm_hmon_database_password = hiera('cm_hmon_database_password', 'hmon')
  ...
  $cm_amon_database_name     = 'amon'
  $cm_amon_database_user     = 'amon'
  $cm_amon_listen_port       = '9999'
  $cm_amon_database_type     = 'postgresql'
  $cm_amon_database_password = 'amon'
  $cm_smon_database_name     = 'smon'
  $cm_smon_database_user     = 'smon'
  $cm_smon_listen_port       = '9997'
  $cm_smon_debug_port        = '8081'
  $cm_smon_database_type     = 'postgresql'
  $cm_smon_database_password = 'smon'
  $cm_hmon_database_name     = 'hmon'
  $cm_hmon_database_user     = 'hmon'
  $cm_hmon_listen_port       = '9995'
  $cm_hmon_database_type     = 'postgresql'
  $cm_hmon_database_password = 'hmon'
